...
<aside class="sidebar text-white">
    <nav class="p-4">
        ...
        <a href="{{ route('dashboard') }}" 
           class="flex items-center gap-3 px-4 py-3 rounded-lg mb-2 {{ request()->routeIs('dashboard') ? 'bg-white text-primary' : 'hover:bg-gray-700' }} transition">
        ...
        @if(auth()->user()->isSuperAdmin())
            ...
            <a href="{{ route('admin.users.index') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-lg mb-2 {{ request()->routeIs('admin.*') ? 'bg-white text-primary' : 'hover:bg-gray-700' }} transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                </svg>
